...
![図1：知能を環境エントロピーから分離する原則](images/fig1_decoupling.pdf)  
...
![図2：MQDBにおけるエンティティ関係の詳細](images/fig2_mqdb_erd.pdf)  
...
![図3：自律的探索プロセス](images/fig3_discovery.pdf)  
...
![図4：ホスト関数の接地による精度統一メカニズム](images/fig4_precision.pdf)  
