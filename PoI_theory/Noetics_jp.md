...
1. **幾何学的構造（Structure）**  
　K-理論や非可換幾何学に基づく作用素レベルの幾何学 [Atiyah 1967; Connes and Marcolli 2006]。  
2. **散逸・崩壊・抽象化（Dissipation）**  
　非平衡熱力学および Onsager の変分原理に基づく構造の減衰と情報選択プロセス [Chen et al. 2024; Fagan 2026]。  
...
　多様体・束・作用素・ゲージ群などの幾何学的基盤 [Melrose 1993; Tong 2018]。  
2. **解析層（Analysis Layer）**  
　半群理論・楕円型作用素論・スペクトル流 [Davies 2006; Cheng 2026]。  
